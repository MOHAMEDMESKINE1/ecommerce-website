...
<div class="container-fluid">
    <div class="row">
      <div class="col-sm-6 text-black">
        ...
        <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
            <form method="POST" style="width: 23rem;" action="{{ route('register') }}">
                @csrf
                <h3 class="fw-normal text-primary mb-3 pb-3" style="letter-spacing: 1px;">Register </h3>
      ...
      <div class="col-sm-6 px-0 d-none d-sm-block mt-5">
        <img src="{{asset('/storage/img/sign.svg')}}"
          alt="Login image" class="w-75 mt-1" style="object-fit: cover; object-position: left;">
      </div>
    </div>
  </div>
</section>
